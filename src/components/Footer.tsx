...
import { Network, Mail, MapPin, Phone } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-white">CR Block</span>
            </div>
            <p className="mt-4 text-gray-400">
              The next generation of blockchain technology, combining the best of blockchain to create a scalable, secure, and decentralized platform.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <a href="#" className="text-base text-gray-400 hover:text-white">Whitepaper</a>
              </li>
              <li>
                <a href="#" className="text-base text-gray-400 hover:text-white">GitHub</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@CR Block.network</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="mt-12 pt-8 border-t border-gray-800">
          <p className="text-base text-gray-400 text-center">
            &copy; 2025 CR Block Network. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
